...
shinyUI(dashboardPage(
  ...
  dashboardSidebar(collapsed =FALSE,
                   sidebarMenu(
                     ...
                     menuItem("Two Salient Objects",tabName="two"
                     ),
                     menuItem("Training",tabName="Train",
                              menuSubItem("Plot Accuracy",tabName = "plt"),
                              menuSubItem("Training Data Summary",tabName = "smr"
                                          )
                                          )
                     ...
                     menuItem("HELP (Documentation)",tabName="helpmenu"
                     )
               ...
               tabItems(
                 tabItem(tabName = "helpmenu",
                        fluidRow(box(title="HELP",
                         ...
                         hr(),
                         h4("1. How to know the number of objects in a scene"),
                        textOutput("help1"),
